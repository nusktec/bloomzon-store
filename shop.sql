...
INSERT INTO `business_settings` (`id`, `type`, `value`, `created_at`, `updated_at`) VALUES (107, 'payfast', '0', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP), (NULL, 'payfast_sandbox', '1', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- --------------------------------------------------------
